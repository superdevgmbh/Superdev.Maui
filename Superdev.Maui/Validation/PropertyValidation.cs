...
namespace Superdev.Maui.Validation
{
    public class PropertyValidation : AbstractValidation, IContextAware
    {
        ...
        /// <exception cref="InvalidOperationException">You can only set the validation criteria once.</exception>
        ...
        /// <returns>The property validation object.</returns>
        /// <exception cref="InvalidOperationException">You can only set the message once.</exception>
